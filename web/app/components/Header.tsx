      ...
      >
        ...
        {openSidebar && (
          <div
            ...
            id="screen"
          >
            <div className="fixed w-[70%] h-screen top-0 right-0  z-[999999999] dark:bg-slate-900 bg-white">
              ...
              <br />
              <br />
              <p className="text-xs px-2 pl-5 text-black dark:text-white">
                CopyRight 2023 Nikolay Gospodinov
              </p>
            </div>
          </div>
        )}
